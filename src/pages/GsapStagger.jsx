    ...
    <main>
      ...
      <div className="mt-20">
        <div className="flex gap-5">
          <div className="w-20 h-20 bg-indigo-200 rounded-lg className" />
          <div className="w-20 h-20 bg-indigo-300 rounded-lg className" />
          <div className="w-20 h-20 bg-indigo-400 rounded-lg className" />
          <div className="w-20 h-20 bg-indigo-500 rounded-lg className" />
          <div className="w-20 h-20 bg-indigo-600 rounded-lg className" />
          <div className="w-20 h-20 bg-indigo-700 rounded-lg className" />
          <div className="w-20 h-20 bg-indigo-800 rounded-lg className" />
        </div>
      </div>
    </main>
  );
